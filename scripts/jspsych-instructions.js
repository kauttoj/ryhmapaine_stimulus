    ...
    function show_current_page() {
      ...
      if (trial.show_clickable_nav) {
        ...
        if (current_page != 0 && trial.allow_backward) {
          nav_html += "<button id='jspsych-instructions-back' class='jspsych-btn'>Edellinen</button>";
        }
        nav_html += "<button id='jspsych-instructions-next' class='jspsych-btn'>Jatka</button></div>"
